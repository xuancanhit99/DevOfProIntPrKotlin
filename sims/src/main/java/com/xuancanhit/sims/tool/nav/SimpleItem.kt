...
class SimpleItem(private val icon: Drawable, private val title: String) :
    ...
    override fun createViewHolder(parent: ViewGroup): ViewHolder {
        ...
        val v: View = inflater.inflate(R.layout.item_nav_option, parent, false)
        return ViewHolder(v)
    }
    ...
    class ViewHolder(itemView: View) : DrawerAdapter.ViewHolder(itemView) {
        ...
        init {
            icon = itemView.findViewById<View>(R.id.iv_stu_item_nav_icon) as ImageView
            title = itemView.findViewById<View>(R.id.tv_stu_item_nav_title) as TextView
        }
    }
}
